...
<html lang="en">
<head>
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-TT16L01ZJB"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-TT16L01ZJB');
    </script>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Veltrik Dashboard</title>
            ...
            <main class="content-area">
                <div class="dashboard-header">
                    <div class="welcome-section">
                        ...
                        <p class="welcome-subtitle">Here's an overview of your Veltrik profile and activities.</p>
                    </div>
